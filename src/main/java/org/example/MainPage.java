...
public class MainPage {
    ...
    // Внутри iframe — сумма, телефон и кнопка оплаты
    ...
    // Заполнить форму "Услуги связи" и нажать на продолжить
    ...
    // Геттеры для данных из iframe
    public String getIFrameAmount() {
        return driver.findElement(iFrameAmount).getText();
    }

    public String getIFramePhone() {
        return driver.findElement(iFramePhone).getText();
    }

    public String getIFramePayButtonText() {
        return driver.findElement(iFramePayButton).getText();
    }

    public String getIFrameLabelText(By locator) {
        return driver.findElement(locator).getText();
    }

    public boolean isIFrameIconDisplayed(By locator) {
        return driver.findElement(locator).isDisplayed();
    }

    // Геттеры для локаторов основных полей
    public By getPhoneConnection() {
        return phoneConnection;
    }

    public By getSumConnection() {
        return sumConnection;
    }

    public By getEmailConnection() {
        return emailConnection;
    }

    public By getPhoneInternet() {
        return phoneInternet;
    }

    public By getSumInternet() {
        return sumInternet;
    }

    public By getEmailInternet() {
        return emailInternet;
    }

    public By getScoreInstalment() {
        return scoreInstalment;
    }

    public By getSumInstalment() {
        return sumInstalment;
    }

    public By getEmailInstalment() {
        return emailInstalment;
    }

    public By getScoreArrears() {
        return scoreArrears;
    }

    public By getSumArrears() {
        return sumArrears;
    }

    public By getEmailArrears() {
        return emailArrears;
    }

    // Геттеры для локаторов iframe
    public By getIFrameLabelCardNumber() {
        return iFrameLabelCardNumber;
    }

    public By getIFrameLabelExpiry() {
        return iFrameLabelExpiry;
    }

    public By getIFrameLabelCvc() {
        return iFrameLabelCvc;
    }

    public By getIFrameLabelHolder() {
        return iFrameLabelHolder;
    }

    public By getIFrameIconVisa() {
        return iFrameIconVisa;
    }

    public By getIFrameIconMastercard() {
        return iFrameIconMastercard;
    }

    public By getIFrameIconBelkart() {
        return iFrameIconBelkart;
    }

    public By getIFrameIconMaestro() {
        return iFrameIconMaestro;
    }
}